          ...
          <table className="w-full border-collapse text-left text-[11px]" style={{ tableLayout: 'fixed' }}>
            <thead>
              <tr className="bg-slate-50 text-slate-700 font-bold border-b border-slate-200 text-[10px]">
                ...
                <th style={{ width: '38%' }} className="py-2 px-2">Item / Description</th>
                <th style={{ width: '11%' }} className="py-2 px-1 text-center">HSN / SAC</th>
                <th style={{ width: '12%' }} className="py-2 px-1.5 text-right">Rate / Item (₹)</th>
                ...
                <th style={{ width: '8%' }} className="py-2 px-1.5 text-right">Tax Amount (₹)</th>
